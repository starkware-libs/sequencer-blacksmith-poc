...
fn get_panel_mempool_transaction_time_until_commit() -> Panel {
    Panel::from_hist(TRANSACTION_TIME_UNTIL_COMMIT, PanelType::TimeSeries)
}
...
pub(crate) fn get_mempool_row() -> Row {
    Row::new(
        ...
        vec![
            ...
            get_panel_mempool_transaction_time_until_commit(),
        ],
    )
}
