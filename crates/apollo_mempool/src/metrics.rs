...
define_metrics!(
    Mempool => {
        ...
        MetricHistogram { TRANSACTION_TIME_UNTIL_COMMIT, "mempool_transaction_time_until_commit", "The time (secs) that a transaction spent in the mempool until it was committed" },
    },
);
...
pub(crate) fn register_metrics() {
    ...
    TRANSACTION_TIME_UNTIL_COMMIT.register();
}
